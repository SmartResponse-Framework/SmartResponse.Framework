...
Function Get-LrtInstallInfo {
    ...
    $UserInstallPath = Join-Path -Path $UserModules.FullName -ChildPath $ModuleInfo.Name
    ...
    $SystemInstallPath = Join-Path -Path $SystemModules.FullName -ChildPath $ModuleInfo.Name
